...
const MediaScreen: React.FC = () => {
  const galleryItems = [
    { id: '1', emoji: '🌳', title: 'Forest Restoration', location: 'Amazon, Brazil' },
    { id: '2', emoji: '🌱', title: 'Seedling Nursery', location: 'Kenya' },
    { id: '3', emoji: '👥', title: 'Community Planting', location: 'India' },
    { id: '4', emoji: '🏔️', title: 'Mountain Reforestation', location: 'Nepal' },
    { id: '5', emoji: '🌊', title: 'Coastal Trees', location: 'Philippines' },
    { id: '6', emoji: '🏜️', title: 'Desert Greening', location: 'Sahel Region' }
  ];
  ...
  return (
    <ScrollView ref={scrollRef} style={styles.screen} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.headerSection}>
        ...
        <Text style={styles.headerSubtitle}>See the impact of our projects</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.videoCard}>
          ...
          <View style={styles.videoInfo}>
            ...
            <Text style={styles.videoDesc}>Watch how we've changed millions of lives</Text>
          </View>
        </View>
        <View style={styles.videoCard}>
          <Text style={styles.videoEmoji}>🎥</Text>
          <View style={styles.videoInfo}>
            ...
            <Text style={styles.videoDesc}>Learn proper tree planting techniques</Text>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  galleryCard: { width: '48%', backgroundColor: '#fff', borderRadius: 12, padding: 12, alignItems: 'center', borderWidth: 1, borderColor: '#C8E6C9' },
  galleryImage: { width: '100%', height: 100, backgroundColor: '#F1F8E9', borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  galleryEmoji: { fontSize: 48 },
  galleryTitle: { fontSize: 13, fontWeight: '700', color: '#1B5E20', textAlign: 'center' },
  galleryLocation: { fontSize: 11, color: '#666', marginTop: 4, textAlign: 'center' },
  section: { paddingHorizontal: 16, paddingVertical: 12 },
  sectionTitle: { fontSize: 18, fontWeight: '700', color: '#1B5E20', marginBottom: 12 },
  videoCard: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 12, backgroundColor: '#fff', borderRadius: 10, marginBottom: 10, borderLeftWidth: 4, borderLeftColor: '#4CAF50' },
  ...
  statRow: { flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 12, backgroundColor: '#C8E6C9', borderRadius: 10 },
  statItem: { alignItems: 'center' },
  statEmoji: { fontSize: 32 },
  statNumber: { fontSize: 18, fontWeight: '800', color: '#1B5E20', marginTop: 6 },
