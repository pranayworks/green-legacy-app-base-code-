...
const ImpactScreen: React.FC = () => {
  ...
  React.useEffect(() => {
    Animated.timing(slideIn, { toValue: 0, duration: 600, useNativeDriver: true }).start();
  }, [slideIn]);
  ...
  <ScrollView ref={scrollRef} contentContainerStyle={styles.container}>
        {/* Header */}
        <Animated.View style={[styles.headerSection, { transform: [{ translateY: slideIn }] }]}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            Each tree planted contributes to environmental restoration. Our calculations are based on peer-reviewed research on average tree growth and environmental benefits.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            We use conservative estimates from environmental research organizations like the EPA and USDA Forest Service. Numbers represent average mature tree values in their 10th-20th years of growth.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  headerSection: { backgroundColor: '#C8E6C9', paddingVertical: 40, alignItems: 'center' },
  headerEmoji: { fontSize: 64 },
  headerTitle: { fontSize: 28, fontWeight: '800', color: '#1B5E20', marginTop: 12 },
  ...
  metricsSection: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around', paddingVertical: 20, backgroundColor: '#F1F8F4' },
  metricCard: { width: '48%', alignItems: 'center', paddingVertical: 16, backgroundColor: '#C8E6C9', borderRadius: 12, marginBottom: 12, marginHorizontal: '1%' },
  metricEmoji: { fontSize: 40 },
  metricTitle: { fontSize: 14, fontWeight: '600', color: '#1B5E20', marginTop: 8 },
  metricValue: { fontSize: 18, fontWeight: '800', color: '#2E7D32', marginTop: 4 },
