      ...
      >
        ...
        <View style={styles.messageContainer}>
          <Text style={styles.message}>
            You've made a real difference! Trees will be planted in your name
            and you'll earn rewards for your contribution.
          </Text>
        </View>
        ...
        <View style={styles.impactBox}>
          ...
          <Text style={styles.impactText}>
            Trees planted for environmental restoration
          </Text>
        </View>
