  ...
  const submit = async () => {
    if (!name || !email || !phone || !skills) {
      Alert.alert(
        ...
        "Name, email, phone and skills are required.",
      );
      return;
    }
    ...
    try {
      ...
      Alert.alert(
        "Thanks!",
        "Your volunteer application has been submitted. We will contact you soon.",
      );
      setName("");
      setEmail("");
      setPhone("");
  ...
  return (
    ...
    >
      ...
      <Text style={styles.blurb}>
        Join our community volunteers to plant trees, run awareness drives, and
        support events. Tell us about yourself below.
      </Text>
      ...
      <TextInput
        ...
        placeholder="Skills (e.g. first aid, logistics) *"
        style={styles.input}
      />
      <TextInput
        value={interests}
        onChangeText={setInterests}
        placeholder="Interests / availability"
