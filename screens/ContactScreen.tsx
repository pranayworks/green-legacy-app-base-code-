...
const ContactScreen: React.FC = () => {
  const contactLinks = [
    { emoji: '📧', title: 'Email', value: 'hello@greenlegacy.org', link: 'mailto:hello@greenlegacy.org' },
    { emoji: '📱', title: 'Phone', value: '+1 (555) 123-4567', link: 'tel:+15551234567' },
    { emoji: '🌐', title: 'Website', value: 'www.greenlegacy.org', link: 'https://www.greenlegacy.org' },
    { emoji: '📍', title: 'Address', value: '123 Green Street, Earth 🌍', link: null }
  ];
    ...
    <ScrollView style={styles.screen} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.faqItem}>
          ...
          <Text style={styles.faqA}>Email us at support@greenlegacy.org with details</Text>
        </View>
        <View style={styles.faqItem}>
          <Text style={styles.faqQ}>❓ How do donations work?</Text>
          <Text style={styles.faqA}>Your donation supports real tree planting projects worldwide</Text>
        </View>
        <View style={styles.faqItem}>
          <Text style={styles.faqQ}>❓ Can I volunteer?</Text>
          <Text style={styles.faqA}>Yes! Contact us to learn about volunteer opportunities</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  contactCard: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, paddingHorizontal: 12, backgroundColor: '#fff', borderRadius: 10, marginBottom: 10, borderLeftWidth: 4, borderLeftColor: '#4CAF50' },
  ...
  socialButton: { width: '23%', paddingVertical: 12, backgroundColor: '#fff', borderRadius: 10, alignItems: 'center', borderWidth: 1, borderColor: '#C8E6C9' },
  socialEmoji: { fontSize: 28 },
  socialLabel: { fontSize: 11, fontWeight: '600', color: '#1B5E20', marginTop: 4 },
  faqItem: { paddingVertical: 12, paddingHorizontal: 12, backgroundColor: '#F1F8E9', borderRadius: 10, marginBottom: 10 },
