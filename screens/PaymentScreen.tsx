...
const PaymentScreen: React.FC<PaymentScreenProps> = ({ route, navigation: nav }) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        nav?.navigate('DonationSuccess', { donationId: 'payment_' + Date.now() });
      }, 2000);
    } catch (error) {
...
const styles = StyleSheet.create({
  ...
  summaryCard: { marginHorizontal: 16, marginVertical: 20, paddingVertical: 16, paddingHorizontal: 12, backgroundColor: '#fff', borderRadius: 10, borderLeftWidth: 4, borderLeftColor: '#4CAF50' },
  ...
  cardContainer: { backgroundColor: '#fff', borderRadius: 10, paddingVertical: 12, paddingHorizontal: 14, borderWidth: 1, borderColor: '#C8E6C9', marginVertical: 12 },
  securityInfo: { flexDirection: 'row', alignItems: 'center', marginVertical: 16, paddingVertical: 12, paddingHorizontal: 12, backgroundColor: '#F1F8E9', borderRadius: 8 },
  securityIcon: { fontSize: 20, marginRight: 8 },
  securityText: { fontSize: 12, color: '#666', flex: 1 },
  payButton: { backgroundColor: '#4CAF50', paddingVertical: 14, borderRadius: 10, alignItems: 'center', marginTop: 20 },
  payButtonDisabled: { opacity: 0.6 },
  payButtonText: { color: '#fff', fontWeight: '700', fontSize: 16 },
  cancelButton: { marginTop: 12, paddingVertical: 12, borderRadius: 10, borderWidth: 1, borderColor: '#CCC', alignItems: 'center' },
